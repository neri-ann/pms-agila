...
const DeleteBudget = () => {
  ...
  const handleDeleteBudget = () => {
    ...
    axios
      ...
      .catch((error) => {
        setLoading(false);
        enqueueSnackbar("Error deleting budget", { variant: "error" });
        console.log(error);
      });
  };
                  ...
                  <DialogBody divider className="grid place-items-center px-6 py-4">
                    ...
                    >
                      <p className="text-red-600 bg-red-50 p-3 rounded-lg border border-red-200">
                        <strong>Warning:</strong> Once you delete this budget, all
                        details of the budget will be permanently removed and cannot
                        be recovered.
                      </p>
                    </Typography>
                  </DialogBody>
