...
import PO_ItemDetails from "./PO_ItemDetails";
import {
    DialogBody,
    DialogFooter,
    DialogHeader,
...
export default function PO_DeleteItems() {
                                    ...
                                    <DialogBody divider className="grid place-items-center px-6 py-4">
                                        ...
                                        >
                                            <p className="text-red-600 bg-red-50 p-3 rounded-lg border border-red-200">
                                                <strong>Warning:</strong> Once you delete this item, all
                                                details of the item will be permanently removed and cannot
                                                be recovered.
                                            </p>
                                        </Typography>
                                    </DialogBody>
